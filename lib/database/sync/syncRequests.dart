...
Future<String?> syncRequests () async {
  ...
  String uri = "http://ec2-107-21-160-174.compute-1.amazonaws.com:8002/api/sync/requests";
...
receiveNewRequestData(db) async {
  ...
  String uri = "http://ec2-107-21-160-174.compute-1.amazonaws.com:8002/api/sync/requests?last_date=${lastSyncDate}";
  final response = await http.get(Uri.parse(uri), headers: { "Authorization": "Bearer ${token}" });
