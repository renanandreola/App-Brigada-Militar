...
Future<String?> syncUsers () async {
  ...
  String uri = "http://ec2-107-21-160-174.compute-1.amazonaws.com:8002/api/sync/users";
...
receiveNewUserData(db) async {
  ...
  String uri = "http://ec2-107-21-160-174.compute-1.amazonaws.com:8002/api/sync/users?last_date=${lastSyncDate}";
  final response = await http.get(Uri.parse(uri), headers: { "Authorization": "Bearer ${token}" });
